...
public class PlayerSound : MonoBehaviour
{
	...
	// ▶︎ 이벤트 수신 핸들러들
	private void HandleSwing(object sender, AttackSkillData skill)
	{
		if (skill != null) Play(skill.swingClip);
	}

	private void HandleHit(object sender, AttackSkillData skill, GameObject _)
	{
		if (skill != null) Play(skill.hitClip);
	}
